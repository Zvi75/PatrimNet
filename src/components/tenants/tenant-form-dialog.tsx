            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-2 sm:col-span-2">
                ...
                <Input
                  ...
                  placeholder="Martin Dupont, SARL Immo…"
                  required
                  autoFocus
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="t-guarantor-contact"
                  value={form.guarantorContact}
                  onChange={(e) => set("guarantorContact")(e.target.value)}
              ...
              <div className="space-y-2 sm:col-span-2">
                ...
                <Select
                  value={form.paymentScore || "none"}
                  onValueChange={(v) => set("paymentScore")(v === "none" ? "" : v)}
                >
                  <SelectTrigger>
