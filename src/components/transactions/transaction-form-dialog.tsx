      ...
      <DialogContent className="max-w-lg">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-2 sm:col-span-2">
                ...
                <Input
                  ...
                  placeholder="Loyer mars — Appartement Marais"
                  required
                  autoFocus
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(v) => set("assetId")(v === "none" ? "" : v)}
                >
                  <SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(v) => set("legalEntityId")(v === "none" ? "" : v)}
                >
                  <SelectTrigger>
                    <SelectValue placeholder="—" />
                  </SelectTrigger>
              ...
              <div className="space-y-2 sm:col-span-2">
                ...
                <Select
                  value={form.leaseId || "none"}
                  onValueChange={(v) => set("leaseId")(v === "none" ? "" : v)}
                >
                  <SelectTrigger>
                    <SelectValue placeholder="—" />
                  </SelectTrigger>
              ...
              <div className="flex items-center gap-2">
                <Checkbox
                  ...
                  onCheckedChange={(v) => set("reconciled")(Boolean(v))}
                />
                <Label htmlFor="tx-rec" className="cursor-pointer">
                  Réconcilié
                </Label>
              </div>
        ...
        <DialogFooter>
          ...
          <Button
            type="submit"
            form="tx-form"
            disabled={loading || !form.label || !form.amount || !form.date}
          >
            {loading ? (
